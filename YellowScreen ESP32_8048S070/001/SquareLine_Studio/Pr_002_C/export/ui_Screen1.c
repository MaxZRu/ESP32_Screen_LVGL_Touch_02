...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_width(ui_Container1, 743);
    lv_obj_set_height(ui_Container1, 419);
    lv_obj_set_align(ui_Container1, LV_ALIGN_CENTER);
    lv_obj_remove_flag(ui_Container1, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_bg_color(ui_Container1, lv_color_hex(0xFCFFD7), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_Button1, -270);
    lv_obj_set_y(ui_Button1, -169);
